...
class MiniCourt:
    ...
    def set_court_drawing_key_points(self):
        ...
        # #point 4
        drawing_key_points[8] = drawing_key_points[0] +  self.convert_meters_pixels(constants.DOUBLE_ALLY_DIFFERENCE)
        drawing_key_points[9] = drawing_key_points[1] 
        # #point 5
        drawing_key_points[10] = drawing_key_points[4] + self.convert_meters_pixels(constants.DOUBLE_ALLY_DIFFERENCE)
    ...
    # define which keypoints are connected by a line
    ...
    def draw_court(self, frame):
        ...
        # draw lines to connect court keypoints
        for line in self.lines:
            start_point = (int(self.drawing_key_points[line[0]*2]), int(self.drawing_key_points[line[0]*2+1]))
            end_point = (int(self.drawing_key_points[line[1]*2]), int(self.drawing_key_points[line[1]*2+1]))
            cv2.line(frame, start_point, end_point, (0,0,0), 2)

        # draw net at the center of the court
    ...
    # below, define a list of minicourts
    ...
    def get_mini_court_coordinates(self, object_position, closest_key_point, closest_key_point_index, player_height_in_pixels, player_height_in_meters):
        ...
        distance_from_keypoint_x_meters = convert_pixel_distance_to_meters(distance_from_key_point_x_pixels, player_height_in_meters, player_height_in_pixels)
        distance_from_keypoint_y_meters = convert_pixel_distance_to_meters(distance_from_key_point_y_pixels, player_height_in_meters, player_height_in_pixels)
    ...
    def convert_bounding_boxes_to_mini_court_positions(self, player_boxes, ball_boxes, original_court_key_points):
        player_heights = {
